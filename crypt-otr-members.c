...
SV* crypt_otr_get_display_cb() { return crypt_otr_display_cb; }
...
void crypt_otr_set_display_cb( SV* in_display_cb ){ crypt_otr_display_cb = in_display_cb; }
